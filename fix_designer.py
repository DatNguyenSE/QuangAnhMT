...
if 'PhuCap_RnD' not in dbml:
    dbml = re.sub(r'(<Table Name="dbo\.taikhoan_tb" Member="taikhoan_tbs">\s*<Type Name="taikhoan_tb">)', r'\1' + new_cols, dbml)
...
if 'PhuCap_RnD' not in cs:
    cs = re.sub(r'(public partial class taikhoan_tb : INotifyPropertyChanging, INotifyPropertyChanged\s*\{)', r'\1\n' + props + events, cs)
