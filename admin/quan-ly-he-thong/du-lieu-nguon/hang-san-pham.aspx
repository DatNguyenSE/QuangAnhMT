<%@ Page Title="Hãng sản phẩm" Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="hang-san-pham.aspx.cs" Inherits="admin_quan_ly_he_thong_du_lieu_nguon_Default" %>
                        ...
                        <div class="bg-white border bd-transparent pl-4 pl-8-md pr-8-md pr-4" style="padding-top: 52px">
                            ...
                            <div class="row">
                                <div class="cell-lg-12">
                                    <div class="mt-3">
                                        <label class="fg-red fw-600">Tên hãng</label>
                            ...
                            <table class="bcorn-fix-title-table">
                                <thead>
                                    <tr class="">
                                        ...
                                        <th class="text-left" style="min-width: 300px;">Tên hãng</th>
                                    </tr>
                                </thead>
